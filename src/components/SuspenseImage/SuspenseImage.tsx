// Stolen from: https://sergiodxa.com/tutorials/react/suspense-image-loading
...
/**
custom element to make <Suspense /> wait for image to be loaded
just put this, inside <Suspense />
*/
